"pagina do git original https://github.com/the-spanish-guy/dotfiles/blob/master/nvim/init.vim
"tutorial https://medium.com/@luyo.lemp/acredito-que-muitos-de-voc%C3%AAs-j%C3%A1-tenham-ouvido-falar-sobre-o-vim-eu-particularmente-sempre-tive-e7bd58955a7f
...
autocmd bufenter * if (winnr("$") == 1 && exists("b:NERDTree") && b:NERDTree.isTabTree()) | q | ndif
" Toggle
